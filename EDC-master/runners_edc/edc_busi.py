...
"""
Baseline EDC runner for BUSI (Breast Ultrasound) dataset.
ImageNet-pretrained ResNet-50 encoder + ResNet-50 decoder. No SSL.
This is the Baseline condition for the BUSI comparison table.
"""
...
def main_worker(gpu, args):
    ...
    # ── Model (baseline: ImageNet encoder) ────────────────────────────────────
    model = R50_R50(
    ...
    print("\n===== FINAL EVALUATION METRICS – Baseline BUSI =====")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Baseline EDC BUSI')

    parser.add_argument('--save_dir',  type=str, default='./saved_models')
    parser.add_argument('--save_name', type=str, default='edc_baseline_busi')
