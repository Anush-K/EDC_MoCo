# runners_edc_ssl/edc_ssl_busi.py
"""
SSL-EDC runner for BUSI (Breast Ultrasound) dataset.
MoCo-pretrained encoder + randomly-initialised decoder.
Supports both SSL-Frozen (freeze_encoder=True) and
SSL-Finetune (freeze_encoder=False) conditions.
"""
...
from models.edc_ssl import MoCo_R50_R50
import warnings
...
def main_worker(gpu, args):
    ...
    print("\n===== FINAL EVALUATION METRICS – SSL-EDC BUSI =====")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='SSL-EDC BUSI')

    parser.add_argument('--save_dir',  type=str, default='./saved_models')
    parser.add_argument('--save_name', type=str, default='edc_ssl_busi')
    ...
    parser.add_argument('--lr_encoder',   type=float, default=1e-5,
                        help='Lower lr for the pretrained encoder during fine-tune')
